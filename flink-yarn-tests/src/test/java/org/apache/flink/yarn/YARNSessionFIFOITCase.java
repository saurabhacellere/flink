...
public class YARNSessionFIFOITCase extends YarnTestBase {
	...
	/**
	 * test normal operation with no extra properties.
	 */
	@Test(timeout = 60000) // timeout after a minute.
	public void testDetachedMode() throws InterruptedException, IOException {
		LOG.info("Starting testDetachedMode()");
		testDetachedModeInternal(Collections.emptyMap());
	}

	/**
	 * Internal test suite with regular operation and command line parameter parsing.
	 */
	void testDetachedModeInternal(Map<String, String> properties) throws InterruptedException, IOException {
