...
/**
 * The factory of {@link MiniBatchedWatermarkAssignerOperator}.
 */
public class MiniBatchedWatermarkAssignerOperatorFactory implements OneInputStreamOperatorFactory<BaseRow, BaseRow> {
	...
	public MiniBatchedWatermarkAssignerOperatorFactory(
	...
	public StreamOperator createStreamOperator(StreamTask containingTask, StreamConfig config, Output output) {
		...
		MiniBatchedWatermarkAssignerOperator operator = new MiniBatchedWatermarkAssignerOperator(
				rowtimeFieldIndex,
				watermarkGenerator,
				idleTimeout,
				minibatchInterval);
	...
	public Class<? extends StreamOperator> getStreamOperatorClass(ClassLoader classLoader) {
		return MiniBatchedWatermarkAssignerOperator.class;
	}
}
