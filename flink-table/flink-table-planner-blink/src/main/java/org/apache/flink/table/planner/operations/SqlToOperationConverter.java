...
public class SqlToOperationConverter {
	...
	private Operation convertSqlInsert(RichSqlInsert insert) {
		...
		return new CatalogSinkModifyOperation(
			targetTablePath,
			(RelQueryOperation) SqlToOperationConverter.convert(flinkPlanner,
				insert.getSource()),
	...
	private RelQueryOperation toQueryOperation(FlinkPlannerImpl planner, SqlNode validated) {
		// transform to a relational tree
		RelRoot relational = planner.rel(validated);
		return new RelQueryOperation(relational.project());
	}
}
