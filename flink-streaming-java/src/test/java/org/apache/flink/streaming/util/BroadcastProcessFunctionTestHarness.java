...
/**
 * A test harness for testing a {@link BroadcastProcessFunction}.
 *
...
public class BroadcastProcessFunctionTestHarness<IN1, IN2, OUT>
	...
	BroadcastProcessFunctionTestHarness<IN1, IN2, OUT> getInitializedTestHarness(
	...
	BroadcastProcessFunctionTestHarness<IN1, IN2, OUT> getInitializedTestHarness(
		...
		BroadcastProcessFunctionTestHarness<IN1, IN2, OUT> testHarness =
			new BroadcastProcessFunctionTestHarness<>(
