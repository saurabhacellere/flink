...
/**
 * A test harness for testing a {@link KeyedBroadcastProcessFunction}.
 *
...
public class KeyedBroadcastProcessFunctionTestHarness<K, IN1, IN2, OUT>
	...
	KeyedBroadcastProcessFunctionTestHarness<K, IN1, IN2, OUT> getInitializedTestHarness(
	...
	KeyedBroadcastProcessFunctionTestHarness<K, IN1, IN2, OUT> getInitializedTestHarness(
		...
		KeyedBroadcastProcessFunctionTestHarness<K, IN1, IN2, OUT> testHarness =
			new KeyedBroadcastProcessFunctionTestHarness<>(
