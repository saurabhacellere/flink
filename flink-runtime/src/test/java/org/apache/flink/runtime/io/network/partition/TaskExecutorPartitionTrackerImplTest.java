...
public class TaskExecutorPartitionTrackerImplTest extends TestLogger {
	...
	public void createClusterPartitionReport() {
		...
		partitionTracker.startTrackingPartition(jobId, clusterPartitionId, dataSetId, numberOfPartitions);
		partitionTracker.startTrackingPartition(jobId, jobPartitionId, dataSetId, numberOfPartitions + 1);
