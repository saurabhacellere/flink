...
public class ZeroCopyNettyMessageDecoder extends ChannelInboundHandlerAdapter {
            ...
            while (data.readableBytes() > 0) {
                ...
                if (decodeStep == DecodeStep.DECODING_MESSAGE_HEADER) {
                    ...
                    if (toDecoder != null) {
                        ...
                        if (intermediateState.messageHeaderParseResult.getDataBufferAction() ==
    ...
    /**
     * Indicates which parts of current message is under decoding.
     */
    ...
    /**
     * Stores the intermediate state produced when decoding the current message.
     */
