...
public class NettyShuffleEnvironmentConfiguration {
	...
	private static int calculateNumberOfNetworkBuffers(
		...
		long nettyArenasSizeBytes = calculateAndCheckNettyArenasSize(numberOfNettyArenas, networkMemorySizeByte);
	...
	private static long calculateAndCheckNettyArenasSize(int numberOfNettyArenas, long networkMemorySizeByte) {
