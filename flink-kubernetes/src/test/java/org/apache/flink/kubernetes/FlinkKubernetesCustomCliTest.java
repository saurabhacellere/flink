...
public class FlinkKubernetesCustomCliTest {
	...
	public void testDynamicProperties() throws Exception {
		...
		FlinkKubernetesCustomCli cli = new FlinkKubernetesCustomCli(
			new Configuration(),
			"",
			"");
		...
		CommandLine cmd = parser.parse(options, new String[]{"run", "-D", "akka.ask.timeout=5 min", "-D",
		...
		Map<String, String> executorConfigMap = executorConfig.toMap();
	...
	public void testResumeFromKubernetesID() throws Exception {
		...
		String clusterId = "my-test-clusterId";
