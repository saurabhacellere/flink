...
public class KubernetesResourceManager extends ResourceManager<KubernetesWorkerNode>
	...
	private List<String> getTaskManagerStartCommand(String podName) {
		final ContaineredTaskManagerParameters taskManagerParameters =
			ContaineredTaskManagerParameters.create(flinkConfig, defaultTaskManagerMemoryMB, numberOfTaskSlots);
		...
		String command = KubernetesUtils.getTaskManagerShellCommand(
			flinkConfig,
			...
			hasLogback,
			hasLog4j,
			TaskManagerRunner.class, // TODO replace with KubernetesTaskExecutorRunner
			getTaskManagerMainClassArgs());
	...
	private String getTaskManagerMainClassArgs() {
		...
		mainClassArgs.append(BootstrapTools.getDynamicProperties(flinkClientConfig, flinkConfig));
